...
public class CommandLineInterface {
    ...
    public void userPromt(String file, DbConnector myDatabase) {
        ...
        for (String[] csvR : dataListEggrafes) {
            vehiclesInf.add(new Vehicle(csvR[0], csvR[1], csvR[2], csvR[3]));
        }
        ...
        do {
            ...
            switch (choice) {
                case 1:
                    ...
                    try {
                        menuF12.vehicleInsuranceStatus(vehiclesInf, licensePlate, vehiclesInfDB, readFrom, writeTo);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    break;
                case 2:
                    ...
                    writeTo = keyboard.nextInt();
                    try {
                        menuF12.forecomingExpiries(vehiclesInf, vehiclesInfDB, readFrom, writeTo, days);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    break;
                ...
                case 4:
                    ...
                    try {
                        ...
                        try {
                            menuF34.fineCalcByOwner(vehiclesInf, vehiclesInfDB, readFrom, writeTo, fine);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    } catch (InputMismatchException exception) {
